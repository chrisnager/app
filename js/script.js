// Force user to save icon to Home Screen
$(document).ready(function() {
  if (!window.navigator.standalone) {
    if (navigator.userAgent.match(/like Mac OS X/i)) {
      $('.container').html('<div class="add"><img src="img/h/apple-touch-icon.png" class="add-icon"><h1 class="add-title">Add to Home Screen</h1><p class="add-arrow">&darr;</p></div>');
